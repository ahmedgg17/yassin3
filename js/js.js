...
let headerDis = `Yassin nabil website`;
...
let aboutYassin =`Yassin Nabil is an 18-year-old amateur MMA fighter, standing at 165 cm tall and competing in the weight range of 52 to 57 kg. He has been training in MMA for a year, gaining valuable experience in the sport. Yassin trains under the guidance of his coach, Omar El-Fayoumi, who has been instrumental in shaping his skills. With a strong dedication to improving his technique and expanding his knowledge of MMA`;
let month =`<span class="month">0</span>`;
let day =`<span class="day">0</span>`;
let year =`<span class="year1">0</span><span class="year2">0</span><span class="year3">0</span><span class="year4">0</span>`;
